...
if ( function_exists( 'get_theme_mod' ) ) {
	...
	if ( function_exists( 'get_theme_mod' ) ) {
		/* Footer  Columns */
		$themo_footer_columns = get_theme_mod( 'themo_footer_columns', 5 );
		$bootstrap_footer_column_class = ''; // Bootstrap 3 grid column size
		switch ($themo_footer_columns) {
			case 1:
				$bootstrap_footer_column_class = "col-md-6 col-md-offset-2 col-sm-8 col-sm-offset-2";
				break;
			case 2:
			...
			case 3:
				...
				break;
			case 4:
				$bootstrap_footer_column_class = "col-md-2 col-sm-6";
				break;
			case 5:
				$bootstrap_footer_column_class = "col-md-2 col-sm-6";
				break;
