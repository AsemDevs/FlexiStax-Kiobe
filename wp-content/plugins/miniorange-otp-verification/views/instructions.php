...
echo'                                   </li>
                                        ...
                                        <li>'.mo_("To add a dropdown to your phone field or select a default country code check the ").'
                                            <i><a href="'.esc_url($otpSettings).'">'.mo_("OTP Settings Tab").'</a></i></li>
                                        <li>'.mo_("To customize your SMS/Email messages/gateway check under").'
                                           <i><a href="'.esc_url($config).'">'.mo_("SMS/Email Templates Tab").'</a></i></li>
                                        ...
                                        <li>'.mo_("For any query related to custom SMS/Email messages/gateway check our").' 
                                           <i><a href="'.esc_url($help_url).'"> '.mo_("FAQs").'</a></i></li>
                                        <li>
                                            <div>
...
echo'                                       </div>
                            ...
                            <div class="mo_otp_note">
                                ...
                                <div id="wp_dropdown" hidden >
                                    '.mo_( "To enable a country dropdown for your phone number field simply enable the option from the Country Code Settings under <i><a href='".esc_url($otpSettings)."'>OTP Settings Tab</a></i>").'
                                </div>
                            </div>
                             <div class="mo_otp_note">
